    ...
    return (
        <div>
            ...
            <div className="mt-5 pl-10">
                <button className="px-5 py-2 text-white bg-green-500 border-none cursor-pointer transition-colors duration-300 hover:bg-green-600"> Show more </button>
            </div>
            ...
            <div className="max-w-5xl mx-auto p-5 text-center pt-10 pb-10">
                ...
                <blockquote className="italic font-medium"><blockquote className="italic font-medium">&quot;I love the bulk class!!! It is really great.&quot;</blockquote>
                &quot;</blockquote>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    {Array(3).fill(null).map((_, index) => (<div key={index} className="bg-green-300 w-full h-40"></div>))}
                </div>
            </div>
            ...
            <div className="max-w-5xl mx-auto p-5">
                <div className="bg-green-500 py-20 mb-20 text-center">
                    <h1 className="text-5xl font-bold text-white">Lessons you love. Guaranteed.</h1>
